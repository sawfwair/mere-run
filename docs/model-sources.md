...
Poolside's Laguna S 2.1 and Laguna XS 2.1 repositories are public and use the
permissive OpenMDW-1.1 license. They are not gated and do not require
`--accept-model-license`; managed downloads retain `LICENSE.md` and immutable
source revisions.
