...
package final class Qwen2VLRotaryEmbedding {
  let dim: Int
  let base: Float
  let invFreq: MLXArray

  package init(dim: Int, base: Float = 1_000_000.0) {
    self.dim = dim
    self.base = base
  ...
  package func callAsFunction(positionIds: MLXArray, dtype: DType = .bfloat16) -> (cos: MLXArray, sin: MLXArray) {
...
package final class Qwen3VLRotaryEmbedding {
  let dim: Int
  let base: Float
  let invFreq: MLXArray
  ...
  package init(dim: Int, base: Float = 1_000_000.0, mropeSection: [Int]) {
    self.dim = dim
    self.base = base
...
package func rotateHalf(_ x: MLXArray) -> MLXArray {
...
package func applyRotaryPosEmb(
...
package func applyMultimodalRoPE(
  _ q: MLXArray, _ k: MLXArray,
  cos: MLXArray, sin: MLXArray,
  mropeSection: [Int]
) -> (MLXArray, MLXArray) {
