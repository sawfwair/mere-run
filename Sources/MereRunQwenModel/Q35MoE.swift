...
package enum Q35FusedSwitchGLUPolicy {
...
/// Expert projection shared with Inkling's LoRA adapter. Swift requires open
/// dispatch for that cross-module subclass; construction stays package-scoped.
open class Q35SwitchLinear: Module {
