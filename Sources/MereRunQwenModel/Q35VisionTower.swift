...
public final class Q35VisionTower: Module {
    ...
    package func installMappedWeights(_ mapped: [String: MLXArray]) throws {
    ...
    package static func mapVisionWeight(_ rawKey: String, _ value: MLXArray) -> [(String, MLXArray)] {
    ...
    package static func mapVisionWeightKey(_ rawKey: String) -> String? {
        var key = rawKey
