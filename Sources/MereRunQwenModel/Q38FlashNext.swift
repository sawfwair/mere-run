...
package final class Q38NGramEmbedding: Module {
    ...
    package var minimumRowCount: Int { Int((headOffsets.last ?? 0) + (headVocabSizes.last ?? 0)) }

    package func installDiskTable(_ table: Q38DiskNGramTable) {
        diskTable = table
        shards = []
    }
