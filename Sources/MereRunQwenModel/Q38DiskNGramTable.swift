...
package final class Q38DiskNGramTable: @unchecked Sendable {
    ...
    package init(indexURL: URL, base: String, shardCount: Int, dimensions: Int, minimumRowCount: Int) throws {
