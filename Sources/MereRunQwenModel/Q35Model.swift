...
public enum Q35LayerCache: @unchecked Sendable {
    ...
    package func fork() -> Q35LayerCache {
        switch self {
    ...
    package func restoreVerificationPrefix(totalTokens: Int, tokenCount: Int) -> Bool {
    ...
    package func canRestoreVerificationPrefix(totalTokens: Int, tokenCount: Int) -> Bool {
    ...
    package func commitVerification() {
        if case .linear(let cache) = self {
            cache.commitVerification()
        }
    }

    package func batched(with caches: [Q35LayerCache]) -> Q35LayerCache? {
    ...
    package func unbatchedRows(count: Int) -> [Q35LayerCache]? {
        switch self {
        case .linear(let cache):
...
package struct Q35ForwardOutput {
    package let hidden: MLXArray
    package let logits: MLXArray
    package let mtpHidden: MLXArray?
}
...
public final class Q35Model: Module, @unchecked Sendable {
    ...
    @discardableResult
    package func prepareFusedSwitchGLU() -> Int {
    ...
    package var q38NGramEmbeddings: [Q38NGramEmbedding] {
    ...
    package func prepareGreedyMTPDrafting() {
    ...
    package func greedyDraftToken(from hidden: MLXArray) -> MLXArray {
    ...
    package func installCoarseDraftHead(
        weight: MLXArray,
        scales: MLXArray,
        biases: MLXArray
    ) {
