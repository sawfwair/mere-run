...
extension MereRunCapabilityCatalog {
    public static let videoGenerate = MereRunCommandCapability(
        ...
        options: [
            ...
            ).scoped(V.used(by: [.ltx25Full], ignoredBy: [.ltxMerged, .ltx23Full, .ltx23A2Vid, .wan, .h3FL2VA, .h3FL2VAQ4, .fastH3Adapter, .fastH3, .h3Ref2VA])),
            .init(
            ...
            ).scoped(V.used(by: [.h3FL2VA, .h3FL2VAQ4, .fastH3Adapter, .fastH3, .h3Ref2VA])),
            .init(
                flag: "--h3-render-height", label: "H3 render height", kind: .integer, group: Group.output, tier: .expert
            ).scoped(V.used(by: [.h3FL2VA, .h3FL2VAQ4, .fastH3Adapter, .fastH3, .h3Ref2VA])),
            // The legacy 4-bit FL2VA checkpoint refuses every Turbo adapter (they need BF16 or Q8),
            // so its adapter strength has no effect either.
            .init(
            ...
            .init(
                ...
                tier: .expert
            ).scoped(V.used(by: [.h3FL2VA, .h3FL2VAQ4, .fastH3Adapter]), .rule(.h3FL2VA, maxCount: 12), .rule(.h3FL2VAQ4, maxCount: 12), .rule(.fastH3Adapter, maxCount: 12)),
            .init(
            ...
            .init(
                ...
                group: Group.sampling, tier: .expert
            ).scoped(V.readOnly(by: [.h3FL2VA, .h3FL2VAQ4, .fastH3Adapter, .h3Ref2VA])),
            ...
            ).scoped(V.rule(.h3FL2VA, values: ["24"], severity: .warning), .rule(.h3FL2VAQ4, values: ["24"], severity: .warning), .rule(.fastH3Adapter, values: ["24"], severity: .warning), .rule(.fastH3, values: ["24"], severity: .warning), .rule(.h3Ref2VA, values: ["24"], severity: .warning)),
            ...
            ).scoped(V.readOnly(by: [.h3FL2VA, .h3FL2VAQ4, .fastH3Adapter, .fastH3, .h3Ref2VA])),
            .init(
            ...
            ).scoped(V.readOnly(by: [.h3FL2VA, .h3FL2VAQ4, .fastH3Adapter, .fastH3, .h3Ref2VA]), .rule(.fastH3, values: ["quality"])),
            .init(
            ...
            ).scoped(V.used(by: [.ltx23Full, .ltx23A2Vid, .ltx25Full])),
            .init(
            ...
            ).scoped(V.used(by: V.allCases), .rule(.ltxMerged, values: ["0"]), .rule(.ltx23Distilled, values: ["0"]), .rule(.ltx23Full, values: ["0"]), .rule(.ltx23A2Vid, values: ["0"]), .rule(.wan, values: ["0"]), .rule(.h3FL2VA, values: ["0"]), .rule(.h3FL2VAQ4, values: ["0"]), .rule(.fastH3Adapter, values: ["0"]), .rule(.fastH3, values: ["0"]), .rule(.h3Ref2VA, values: ["0"])),
            .init(
