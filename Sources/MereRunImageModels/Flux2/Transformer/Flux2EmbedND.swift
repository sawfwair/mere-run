...
package final class Flux2PosEmbed: Module {
    let theta: Float
    let axesDim: [Int]

    package init(theta: Float = 2000, axesDim: [Int] = [32, 32, 32, 32]) {
        self.theta = theta
    ...
    package func callAsFunction(_ ids: MLXArray) -> (MLXArray, MLXArray) {
        var cosOut: [MLXArray] = []
        var sinOut: [MLXArray] = []
    ...
    package static func get1DRotaryPosEmbed(dim: Int, pos: MLXArray, theta: Float) -> (MLXArray, MLXArray) {
        // pos shape: [seq_len]
    ...
    package static func applyRotaryEmb(_ x: MLXArray, freqs: (MLXArray, MLXArray)) -> MLXArray {
    ...
    package static func prepareTextIds(seqLen: Int, numAxes: Int = 4) -> MLXArray {
    ...
    package static func prepareImageIds(height: Int, width: Int) -> MLXArray {
    ...
    package static func prepareMultiImageIds(
        imageCount: Int,
        height: Int,
        width: Int,
        tCoords: [Int]
