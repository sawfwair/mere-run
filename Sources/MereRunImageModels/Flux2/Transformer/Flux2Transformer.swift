...
package final class Flux2TransformerBlock: Module {
    ...
    package init(config: Flux2TransformerConfiguration, placeholder: Bool) {
        self.hiddenSize = config.hiddenSize
        self.eps = config.eps
...
package final class Flux2SingleTransformerBlock: Module {
