...
extension ZImageTurboTransformerConfig {
    package static let mfluxZImageTurbo = ZImageTurboTransformerConfig(
        inChannels: 16,
        dim: 3840,
        nLayers: 30,
        nRefinerLayers: 2,
...
extension ZImageTurboVAEConfig {
    package static let mfluxZImageTurbo = ZImageTurboVAEConfig(
        actFn: "silu",
...
extension ZImageTurboSchedulerConfig {
    package static let mfluxZImageTurbo = ZImageTurboSchedulerConfig(
...
extension ZImageTurboTextEncoderConfig {
    package static let mfluxZImageTurbo = ZImageTurboTextEncoderConfig(
        attentionBias: false,
