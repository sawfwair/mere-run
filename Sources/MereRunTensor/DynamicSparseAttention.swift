...
package struct DynamicSparseAttentionRequest: Sendable, Equatable {
    package let prefixTokenCount: Int
    package let thresholdStandardDeviations: Float
}

package struct DynamicSparseAttentionPolicy: Sendable, Equatable {
    package let thresholdStandardDeviations: Float
    package let minimumSequenceLength: Int
    package let denseLeadingStepFraction: Float
    package let denseTrailingStepCount: Int
    package let denseLeadingLayerCount: Int
...
package struct DynamicSparseAttentionGate: Sendable, Equatable {
    package let maximumAbsoluteError: Float
    package let meanAbsoluteError: Float
    package let maximumRelativeError: Float
    package let meanRelativeError: Float
    package let relativeL2Error: Float
...
package enum DynamicSparseAttention {
    package static let blockSize = 64
    package static let headDimension = 128

    package struct RoutePlan {
    ...
    package static func denseRouteGate(
        queries: MLXArray,
        keys: MLXArray,
        values: MLXArray,
        queryStart: Int,
    ...
    package static func makeRoutePlan(
        queries: MLXArray,
        keys: MLXArray,
        values: MLXArray,
        queryStart: Int,
