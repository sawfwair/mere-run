...
`MereRunTensor/DynamicSparseAttention.swift` implements batch-one, head-dimension-128
...
`MereRunImageModels/ZImage/DynamicSparseAttentionRuntime.swift` owns the reusable step, layer, sequence,
