    ...
    private static let descriptorsByID: [String: ManagedModelCapabilityDescriptor] = {
        let descriptors = [
            ...
            descriptor(
                ...
                "Qwen3.8 Flash Next activation-weighted Q3 vision chat",
                "Runs Sawfwair's pinned Q3 expert profile with Q4 core matrices and a measured 62.1 GB peak on the 128 GiB qualification host.",
                minimum: 96,
                recommended: 128
            ),
            descriptor(
            ...
            descriptor(GLiNERCatalog.modelID, "GLiNER2.5 Decide classification",
                       "Native DeBERTa text classification with caller supplied labels; English checkpoint.",
