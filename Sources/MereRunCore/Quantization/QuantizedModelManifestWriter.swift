...
public enum QuantizedModelManifestWriter {
    public static func writeQuantizedModelManifest(
        ...
        let family = baseManifest.family ?? inferFamily(from: id) ?? {
            ...
            case .qwenImageEdit, .qwenImage21: return .qwen
            ...
            case .aceStep, .miniMaxMusic3, .yue2, .magentaRT2, .muScriptor, .roFormer: return .music
            case .apBWE, .univerSR, .auk: return .audio
        ...
        let supports: [MereRunModelManifest.Capability] = {
            let baseline: [MereRunModelManifest.Capability] = baseManifest.supports ?? {
                ...
                case .lightOnOCR:
                    return [.visionOCR]
                case .aceStep, .miniMaxMusic3, .yue2, .magentaRT2:
        ...
        if manifest.defaults == nil {
            ...
            case .qwenImage21:
                manifest.defaults = MereRunModelManifest.Defaults(steps: 40, cfg: 1.0)
            case .qwenImageEdit:
            ...
            case .yue2:
                manifest.defaults = MereRunModelManifest.Defaults(steps: 32, cfg: 1)
            case .wanVideo:
