...
struct TextChat: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        Known model IDs:
          ...
          - text-agent-ornith-35b-mlx-4bit (Ornith 1.5 35B-A3B MLX speed tier)
          - text-agent-ornith-35b-mlx-6bit (Ornith 1.5 35B-A3B MLX balanced tier)
          - text-agent-ornith-35b-mlx-8bit (Ornith 1.5 35B-A3B MLX quantized quality tier)
          ...
          - text-chat-lfm25-1.2b-qad-4bit (LiquidAI LFM2.5 1.2B QAD 4-bit native MLX)
          - text-chat-lfm25-2.6b-bf16 (LiquidAI LFM2.5 2.6B BF16 with DSpark)
          - text-chat-lfm25-2.6b-qad-4bit (LiquidAI LFM2.5 2.6B QAD 4-bit native MLX)
