...
extension CommandCatalog {
    static let speechTemplates: [CommandTemplate] = [
        CommandTemplate(
            id: .speechSynthesize,
            category: .speech,
            title: "Synthesize",
...
extension CommandArguments {
    static func speechSynthesize(_ draft: CommandDraft) -> [String] {
    ...
    static func speechTranscribe(_ draft: CommandDraft) -> [String] {
    ...
    static func speechDiarize(_ draft: CommandDraft) -> [String] {
    ...
    static func speechProfileList(_ draft: CommandDraft) -> [String] {
        CommandFlags.SpeechProfileList.command
    }

    static func speechProfileCreate(_ draft: CommandDraft) -> [String] {
    ...
    static func speechProfileDelete(_ draft: CommandDraft) -> [String] {
    ...
    static func speechListen(_ draft: CommandDraft) -> [String] {
