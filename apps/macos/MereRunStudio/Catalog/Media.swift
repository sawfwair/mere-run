...
extension CommandCatalog {
    static let mediaTemplates: [CommandTemplate] = [
        CommandTemplate(
            id: .audioEnhance,
            category: .media,
            title: "Enhance audio",
...
extension CommandArguments {
    static func musicGenerate(_ draft: CommandDraft) -> [String] {
    ...
    static func videoGenerate(_ draft: CommandDraft) -> [String] {
    ...
    static func videoRetake(_ draft: CommandDraft) -> [String] {
    ...
    static func videoDubIt(_ draft: CommandDraft) -> [String] {
    ...
    static func videoAnimate(_ draft: CommandDraft) -> [String] {
    ...
    static func videoCosmos3(_ draft: CommandDraft) -> [String] {
    ...
    static func videoPrepareMasks(_ draft: CommandDraft) -> [String] {
    ...
    static func videoExportLatents(_ draft: CommandDraft) -> [String] {
    ...
    static func videoSession(_ draft: CommandDraft) -> [String] {
    ...
    static func audioEnhance(_ draft: CommandDraft) -> [String] {
    ...
    static func audioGenerate(_ draft: CommandDraft) -> [String] {
    ...
    static func musicAnalyze(_ draft: CommandDraft) -> [String] {
    ...
    static func musicTranscribe(_ draft: CommandDraft) -> [String] {
    ...
    static func musicSeparate(_ draft: CommandDraft) -> [String] {
    ...
    static func musicRealtime(_ draft: CommandDraft) -> [String] {
    ...
    static func musicTrainAdapter(_ draft: CommandDraft) -> [String] {
    ...
    static func musicServe(_ draft: CommandDraft) -> [String] {
