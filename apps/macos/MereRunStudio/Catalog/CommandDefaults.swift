...
struct DraftDefault: Sendable {
    ...
    static func contract<Value: LosslessStringConvertible & Sendable>(
    ...
    func apply(to draft: inout CommandDraft, capability: MereRunCommandCapability?) {
...
enum CommandDefaults {
    static func apply(to draft: inout CommandDraft, id: CommandTemplateID) {
    ...
    static let byTemplate = Dictionary(
