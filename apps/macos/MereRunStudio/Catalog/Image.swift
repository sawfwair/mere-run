...
extension CommandCatalog {
    static let imageTemplates: [CommandTemplate] = [
        CommandTemplate(
            id: .imageGenerate,
            category: .image,
...
extension CommandArguments {
    static func imageGenerate(_ draft: CommandDraft) -> [String] {
    ...
    static func imageTrainLoRA(_ draft: CommandDraft) -> [String] {
    ...
    static func imageValidate(_ draft: CommandDraft) -> [String] {
    ...
    static func imageDatasetDiscover(_ draft: CommandDraft) -> [String] {
    ...
    static func imageRunPlan(_ draft: CommandDraft) -> [String] {
    ...
    static func imageVisualizeRun(_ draft: CommandDraft) -> [String] {
    ...
    static func imageReconstruct3D(_ draft: CommandDraft) -> [String] {
    ...
    static func imageReconstruct3DTrellis2(_ draft: CommandDraft) -> [String] {
    ...
    static func imageReconstruct3DMultiview(_ draft: CommandDraft) -> [String] {
