...
struct ArgumentBuilder {
    ...
    init<Flags: CommandFlagNamespace>(_ flags: Flags.Type) {
    ...
    mutating func optionUnlessDefault(_ flag: String, _ value: String) {
