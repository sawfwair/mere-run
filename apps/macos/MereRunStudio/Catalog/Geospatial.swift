...
extension CommandCatalog {
    static let geospatialTemplates: [CommandTemplate] = [
        CommandTemplate(
            id: .geoFlood,
            category: .geospatial,
...
extension CommandArguments {
    static func geoFlood(_ draft: CommandDraft) -> [String] {
    ...
    static func geoFire(_ draft: CommandDraft) -> [String] {
    ...
    static func geoTessera(_ draft: CommandDraft) -> [String] {
    ...
    static func geoOlmoEarth(_ draft: CommandDraft) -> [String] {
