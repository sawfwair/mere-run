...
enum CommandArguments {
    static func build(for id: CommandTemplateID, draft: CommandDraft) -> [String] {
        switch id {
...
extension CommandArguments {
    ...
    static func lineList(_ raw: String) -> [String] {
    ...
    static func pathList(_ raw: String) -> [String] {
        raw.components(separatedBy: .newlines)
    ...
    static func appendFaceOptions(to args: inout ArgumentBuilder, draft: CommandDraft) {
