...
extension CommandCatalog {
    static let setupTemplates: [CommandTemplate] = [
        CommandTemplate(
            id: .setup,
            category: .setup,
            title: "Setup path",
...
extension CommandArguments {
    static func setup(_ draft: CommandDraft) -> [String] {
    ...
    static func agentOnboard(_ draft: CommandDraft) -> [String] {
    ...
    static func agentStatus(_ draft: CommandDraft) -> [String] {
    ...
    static func agentInstallPi(_ draft: CommandDraft) -> [String] {
    ...
    static func agentStart(_ draft: CommandDraft) -> [String] {
