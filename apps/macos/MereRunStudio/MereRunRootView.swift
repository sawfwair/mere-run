...
/// Settings, as four tabs: General (paths), Models (Hugging Face, storage), Server (the runtime
/// endpoint the app talks to), Advanced (CLI install, skill, stored configuration, diagnostics).
