...
enum StudioContractValue: Equatable {
    case text(String)
    case integer(Int)
    case number(Double)
    case flag(Bool)
...
extension StudioContractBinding {
    ...
    static func integer(_ id: String, _ keyPath: WritableKeyPath<StudioDraft, Int>) -> Self {
        Self(
            fieldID: id,
    ...
    static func number(_ id: String, _ keyPath: WritableKeyPath<StudioDraft, Double>) -> Self {
        Self(
            fieldID: id,
    ...
    static func flag(_ id: String, _ keyPath: WritableKeyPath<StudioDraft, Bool>) -> Self {
        Self(
            fieldID: id,
    ...
    static func invertedFlag(_ id: String, _ keyPath: WritableKeyPath<StudioDraft, Bool>) -> Self {
        Self(
            fieldID: id,
            read: { .flag(!$0[keyPath: keyPath]) },
            write: { draft, value in
    ...
    static func choice<Choice: RawRepresentable>(
        _ id: String,
    ...
    static func integerText(_ id: String, _ keyPath: WritableKeyPath<StudioDraft, String>) -> Self {
        Self(
            fieldID: id,
            read: { draft in
    ...
    static func optionalText(_ id: String, _ keyPath: WritableKeyPath<StudioDraft, String?>) -> Self {
        Self(
            fieldID: id,
            read: { draft in
    ...
    static func optionalInteger(_ id: String, _ keyPath: WritableKeyPath<StudioDraft, Int?>) -> Self {
        Self(
            fieldID: id,
            read: { draft in
    ...
    static func optionalNumber(_ id: String, _ keyPath: WritableKeyPath<StudioDraft, Double?>) -> Self {
        Self(
            fieldID: id,
            read: { draft in
                guard let value = draft[keyPath: keyPath] else { return .unset }
...
enum StudioContractGroup: String, CaseIterable, Identifiable, Hashable {
    case prompt = "Prompt"
    case inputs = "Inputs"
    case output = "Output"
    ...
    static func group(forFlag flag: String, in capability: MereRunCommandCapability?) -> StudioContractGroup {
...
enum StudioContractChoiceTitles {
    static func title(for choice: String, flag: String) -> String {
...
enum StudioContractControl: Equatable {
...
struct StudioContractField: Identifiable {
    ...
    var id: String { option.flag }
    var flag: String { option.flag }
    var label: String { option.label }
    var kind: MereRunCapabilityValueKind { option.kind }
    var group: StudioContractGroup { StudioContractGroup(contractGroup: option.group) }
    var tier: MereRunCapabilityOptionTier { option.tier ?? .standard }
    ...
    var control: StudioContractControl {
    ...
    var defaultValue: StudioContractValue {
    ...
    func clamped(_ value: StudioContractValue) -> StudioContractValue {
...
enum StudioContractSchema {
    /// The capability a mode's current draft runs, which for Read Image depends on the action.
    static func capability(for mode: StudioMode, draft: StudioDraft) -> MereRunCommandCapability? {
    ...
    static func sections(for mode: StudioMode, draft: StudioDraft) -> [StudioContractSection] {
    ...
    static func dependencies(for mode: StudioMode, draft: StudioDraft) -> [String: (carries: Bool, dependsOn: String?)] {
    ...
    static func roundTrip(_ draft: inout StudioDraft, for mode: StudioMode) {
    ...
    static func draftFieldIDs(for mode: StudioMode, draft: StudioDraft = StudioDraft()) -> Set<String> {
...
enum StudioContractOverrideID: String, CaseIterable, Hashable {
...
struct StudioContractOverride {
    let id: StudioContractOverrideID
...
enum StudioContractOverrides {
    static func overrides(for mode: StudioMode) -> [StudioContractOverride] {
    ...
    static func override(forFlag flag: String, mode: StudioMode) -> StudioContractOverride? {
...
extension StudioDraft {
    ...
    var h3ReferenceInputsText: String {
