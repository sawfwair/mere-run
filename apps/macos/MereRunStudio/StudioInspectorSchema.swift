...
enum StudioInspectorSchema {
    ...
    static func sections(for mode: StudioMode, draft: StudioDraft = StudioDraft()) -> [StudioContractSection] {
    ...
    static func advancedChanged(mode: StudioMode, draft: StudioDraft, baseline: StudioDraft) -> Bool {
