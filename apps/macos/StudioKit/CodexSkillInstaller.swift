...
package enum CodexSkillInstallError: LocalizedError {
...
package enum CodexSkillInstallOutcome: Equatable {
    case installed(names: [String], destination: URL)
    case skippedNoBundledSkills
    case failed(String)
}

package enum CodexSkillInstaller {
    package static func installBundledSkillsIfAvailable(
    ...
    package static func installSkills(
        from sourceURL: URL,
    ...
    package static func bundledSkillsURL(
        fileManager fm: FileManager = .default,
        bundle: Bundle = .main
    ) -> URL? {
    ...
    package static func defaultCodexSkillsDirectory(fileManager fm: FileManager = .default) -> URL {
