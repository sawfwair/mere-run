...
package enum CLIInstallationKind: Equatable, Sendable {
    case none
    case studioManaged
    case bundledSymlink
    case unowned
...
package enum CLIInstallationPhase: Equatable, Sendable {
    case install
    case upToDate
    case update
    case repair
...
package struct CLIInstallationStatus: Equatable, Sendable {
    package let phase: CLIInstallationPhase
    package let kind: CLIInstallationKind
    package let resolvedPath: String?
    package let installedVersion: String?
    package let bundledVersion: String?
    package let detail: String
    package let lastSynchronizationError: String?
    package let allowsManualAction: Bool

    package static let checking = Self(
        phase: .synchronizing,
        kind: .none,
        resolvedPath: nil,
...
package struct CLIInstallationContext: Equatable, Sendable {
    package let bundledPayloadURL: URL?
    package let paths: CLIInstallationPaths
    package let studioBuild: CLIStudioBuild
    package let customCLIPath: String
...
package enum CLIInstallationSynchronizer {
    ...
    package static func synchronizeAfterLaunch(
        context: CLIInstallationContext,
        fileManager fm: FileManager = .default
    ) -> CLIInstallationStatus {
    ...
    package static func performManualAction(
        context: CLIInstallationContext,
        fileManager fm: FileManager = .default
    ) -> CLIInstallationStatus {
        let current = inspection(context: context, fileManager: fm)
