...
extension CommandCatalog {
    package static let modelsTemplates: [CommandTemplate] = [
...
extension CommandArguments {
    package static func modelList(_ draft: CommandDraft) -> [String] {
        CommandFlags.ModelList.command
    }

    package static func modelCapabilities(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelPull(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelInfo(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelRemove(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelRepairManifests(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelOptimize(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmark(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkLagunaDFlash(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelLocationList(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelLocationAdd(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelLocationRemove(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelLocationBind(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelLocationUnbind(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkCode(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkFused(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkFusedFixture(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkVLM(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkToolContinuations(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkAPIWorkload(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkChat(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkToolCalls(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkGemma4KV(_ draft: CommandDraft) -> [String] {
    ...
    package static func modelBenchmarkGemma4MTP(_ draft: CommandDraft) -> [String] {
