...
extension CommandCatalog {
    package static let serverTemplates: [CommandTemplate] = [
        CommandTemplate(
            id: .pluginList,
            category: .server,
            title: "Plugins",
...
extension CommandArguments {
    package static func pluginList(_ draft: CommandDraft) -> [String] {
    ...
    package static func pluginInstall(_ draft: CommandDraft) -> [String] {
    ...
    package static func pluginDoctor(_ draft: CommandDraft) -> [String] {
    ...
    package static func openWebui(_ draft: CommandDraft) -> [String] {
    ...
    package static func apiServe(_ draft: CommandDraft) -> [String] {
    ...
    package static func pluginInfo(_ draft: CommandDraft) -> [String] {
    ...
    package static func pluginRun(_ draft: CommandDraft) -> [String] {
    ...
    package static func pluginRollback(_ draft: CommandDraft) -> [String] {
    ...
    package static func visionServe(_ draft: CommandDraft) -> [String] {
