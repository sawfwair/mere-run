...
extension CommandCatalog {
    package static let soundFXTemplates: [CommandTemplate] = [
        CommandTemplate(
            id: .sfxGenerate,
            category: .sfx,
...
extension CommandArguments {
    ...
    package static func sfxAEEncode(_ draft: CommandDraft) -> [String] {
    ...
    package static func sfxAEDecode(_ draft: CommandDraft) -> [String] {
    ...
    package static func sfxClapScore(_ draft: CommandDraft) -> [String] {
    ...
    package static func sfxConditionText(_ draft: CommandDraft) -> [String] {
