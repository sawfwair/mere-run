...
package final class StudioTaskRunner {
    ...
    @discardableResult
    package func submitVariations(_ requests: [StudioRunRequest], task: StudioTask) -> [StudioRunRequest] {
    ...
    package func replayVariations(of item: StudioLibraryItem, seeds: [String]) throws -> [StudioRunRequest] {
        ...
        return submitVariations(requests, task: StudioVariations.submittingTask(for: item))
    }
