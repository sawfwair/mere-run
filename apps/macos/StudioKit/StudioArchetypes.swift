...
extension StudioTask {
    ...
    /// renders the archetype's canvas over the task's `StudioTaskDraft` instead. Every other task
    /// looks and behaves exactly as before.
    package static let migratedTasks: Set<StudioTask> = [.threeDFromImage]
