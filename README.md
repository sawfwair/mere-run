...
| Video and worlds | `video generate`, `video session`, `video export-latents`, `world serve` | LTX video, synchronized LTX 2.3 audio/video, a resident distilled LTX worker, Wan 2.2 TI2V, and a warm DreamX causal world session with camera-conditioned transitions |
